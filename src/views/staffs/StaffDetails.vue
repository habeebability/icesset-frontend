      ...
      <div class="request-div bg-white p-1 lg:p-5 w-full rounded-md">
        ...
        <div>
          <div class="flex items-center border-b">
            <div class="mr-6">
              <svg width="24" height="30" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14 0C8.18333 0 3.5 4.46032 3.5 10V11.6667C1.58714 11.6667 0 13.1782 0 15V31.6667C0 33.4884 1.58714 35 3.5 35H24.5C26.4129 35 28 33.4884 28 31.6667V15C28 13.1782 26.4129 11.6667 24.5 11.6667V10C24.5 4.46032 19.8167 0 14 0ZM14 3.33333C17.9833 3.33333 21 6.20635 21 10V11.6667H7V10C7 6.20635 10.0167 3.33333 14 3.33333ZM3.5 15H24.5V31.6667H3.5V15ZM14 20C12.075 20 10.5 21.5 10.5 23.3333C10.5 25.1667 12.075 26.6667 14 26.6667C15.925 26.6667 17.5 25.1667 17.5 23.3333C17.5 21.5 15.925 20 14 20Z" fill="#540D6E"/>
              </svg>
            </div>
            ...
            <form v-if="showChangePassword" @submit.prevent="handleChangePassword">
              ...
              <div class="flex md:hidden justify-between">
                ...
                <div class="mb-6 relative">
                  <label for="password" class="block mb-2 text-xs text-gray-900 dark:text-gray-300">
                    New Password
              ...
              <div class="md:block hidden">
                ...
                <div class="mb-6 relative">
                  <label for="password" class="block mb-2 text-sm md:text-lg ml-4 text-gray-900 dark:text-gray-300">
                    New Password
